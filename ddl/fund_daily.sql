...
create table `fund_daily` (
                               ...
                               `open` decimal(18,3) default 0 comment '开盘价',
                               high decimal(18,3) default 0 comment '最高价',
                               low decimal(18,3) default 0 comment '最低价',
                               `close` decimal(18,3) default 0 comment '收盘价',
                               pre_close decimal(18,3) default 0 comment '昨收价',
                               `change` decimal(18,3) default 0 comment '涨跌额',
                               pct_chg decimal(18,3) default 0 comment '涨跌幅',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='指数列表';
